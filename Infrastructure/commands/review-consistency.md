...
Run the shared pipeline-detection procedure in `Infrastructure/rules/review-pipeline-runner.md`, substituting `<review-type>` = "document–code consistency review".
