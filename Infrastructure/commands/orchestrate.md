...
1. Read:
   - `Infrastructure/agents/orchestrator.md`
...
7. Report status and next action using `Infrastructure/templates/orchestration-plan.md`.

## Constraints

1. Respect `Infrastructure/rules/performance-cost-governance.md` for expensive runs.
