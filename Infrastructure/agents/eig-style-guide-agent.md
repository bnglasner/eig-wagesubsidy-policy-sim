...
For Datawrapper work, also apply `Infrastructure/rules/style-datawrapper-rules.md` (manifest fields, palette-mode policy, and the compliance validators it points to).
