...
Read `Infrastructure/rules/code-quality-rules.md` in full.
Read `Infrastructure/templates/code-error-report.md` in full.
...
2. Read `Infrastructure/templates/code-error-report.md` and use its HTML structure exactly.
