...
Read `Infrastructure/rules/methodology-rules.md` in full.
Read `Infrastructure/templates/methodology-report.md` in full.
...
2. Read `Infrastructure/templates/methodology-report.md` and use its HTML structure exactly.
