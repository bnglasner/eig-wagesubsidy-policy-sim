...
Output
------
data/external/asec_earners_{YYYY}.parquet
...
Usage
-----
    python code/01_data_preparation/01d_asec_preprocess.py
"""
...
def main() -> None:
    ...
    print(f"\nNext step: python code/01_data_preparation/01e_match_org_to_asec.py")
