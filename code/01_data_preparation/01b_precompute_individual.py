...
Output
------
output/data/intermediate_results/individual_schedules/{key}_{state}.parquet
...
Run from the project root:
    ...
    python code/01_data_preparation/01b_precompute_individual.py

Or via the pipeline:

    python code/run_all.py   (set RUN_01B_PRECOMPUTE_INDIVIDUAL = True)
"""
...
PROJECT_ROOT = _HERE.parents[2]          # eig-wagesubsidy-policy-sim/
