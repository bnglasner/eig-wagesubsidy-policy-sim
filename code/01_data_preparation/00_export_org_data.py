...
repository and writes a trimmed, EIG-specific file to data/external/.
...
Output
------
data/external/org_workers_{year}.parquet
...
def _find_real_wages_org_dir() -> Path:
    ...
    candidates = [
        _HERE.parents[3] / "real-wages-generations-ipums",   # common sibling layout
        _HERE.parents[2] / "real-wages-generations-ipums",
        _HERE.parents[1] / "real-wages-generations-ipums",
    ]
    for c in candidates:
