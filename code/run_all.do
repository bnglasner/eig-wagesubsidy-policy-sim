...
local script_id "01a"
local stage_num "01"
local script_path "code/01_data_preparation/01a_data_ingest.do"
...
local script_id "02a"
local stage_num "02"
local script_path "code/02_descriptive_analysis/02a_descriptive_stats.do"
...
local script_id "03a"
local stage_num "03"
local script_path "code/03_main_estimation/03a_main_model.do"
...
local script_id "04a"
local stage_num "04"
local script_path "code/04_robustness_heterogeneity/04a_robustness_checks.do"
...
local script_id "05a"
local stage_num "05"
local script_path "code/05_figures_tables/05a_main_outputs.do"
