...
local({
  ...
  if (!nzchar(root)) {
    ...
    for (i in seq_len(10L)) {
      if (file.exists(file.path(cur, "code", "run_all.R"))) {
        root <- cur
        break
      }
...
source("code/00_setup/00_config.R")
...
run_script(
  script_id = "01a",
  stage = "01",
  script_path = "code/01_data_preparation/01a_data_ingest.R",
  label = "Data ingest",
...
run_script(
  script_id = "02a",
  stage = "02",
  script_path = "code/02_descriptive_analysis/02a_descriptive_stats.R",
...
run_script(
  script_id = "03a",
  stage = "03",
  script_path = "code/03_main_estimation/03a_main_model.R",
  label = "Main model",
...
run_script(
  script_id = "04a",
  stage = "04",
  script_path = "code/04_robustness_heterogeneity/04a_robustness_checks.R",
...
run_script(
  script_id = "05a",
  stage = "05",
  script_path = "code/05_figures_tables/05a_main_figures.R",
  label = "Main figures",
