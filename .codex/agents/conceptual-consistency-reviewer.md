...
Read `.codex/rules/doc-consistency-rules.md` in full.
Read `.codex/templates/doc-consistency-report.md` in full.
...
2. Read `.codex/templates/doc-consistency-report.md` and use its HTML structure exactly.
