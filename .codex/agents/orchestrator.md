...
3. `.codex/rules/plan-first-workflow.md`
4. `.codex/rules/verification-protocol.md`
5. `.codex/rules/performance-cost-governance.md`
6. Relevant specialist agent files under `.codex/agents/`
7. Relevant command playbooks under `.codex/commands/`
...
1. A proposed run exceeds the thresholds in `.codex/rules/performance-cost-governance.md`.
...
2. A dependency-aware execution plan using `.codex/templates/orchestration-plan.md`.
