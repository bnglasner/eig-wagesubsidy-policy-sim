...
2. `.codex/rules/maintenance-rules.md`
3. `.codex/rules/performance-cost-governance.md`
4. `.codex/rules/verification-protocol.md`
5. `.codex/templates/maintenance-report.md`
...
5. Run dependency freshness checks when matching files exist:
   ...
   - R: `renv.lock`
   - Node: `package.json`
6. Classify each finding using `.codex/rules/maintenance-rules.md`.
7. Produce a report using `.codex/templates/maintenance-report.md`.
