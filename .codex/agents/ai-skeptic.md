...
Read and follow `.codex/rules/ai-skeptic-rules.md` exactly before beginning any review.
...
Read `.codex/rules/ai-skeptic-rules.md` in full.
Read `.codex/templates/ai-skeptic-report.md` in full.
...
2. Read the template: `.codex/templates/ai-skeptic-report.md`
...
2. Read `.codex/templates/ai-skeptic-report.md` and use its HTML structure exactly.
