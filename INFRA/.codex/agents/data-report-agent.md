...
5. The report must be re-runnable: invoking this agent again after the pipeline executes should update all `[PIPELINE NOT YET RUN]` placeholders with actual values.
