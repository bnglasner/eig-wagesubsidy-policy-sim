...
Step 3: Data Export to EIG Repo (Python, manual or scripted)
   ...
   - Save to data/external/org_workers_{YYYY}.parquet in EIG repo

Step 4: Worker Identification (EIG repo, Python)
   code/01_data_preparation/01a_data_ingest.py  [REWRITTEN]
   ...
   Output: data/processed/hourly_workers.parquet
...
Step 6: Verification (EIG repo, Python) — UNCHANGED
   code/05_figures_tables/05a_main_outputs.py
```
