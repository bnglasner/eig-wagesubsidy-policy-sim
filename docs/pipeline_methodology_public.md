...
- `code/01_data_preparation/00_export_org_data.py`
...
- Exports trimmed columns to `data/external/org_workers_{max_year}.parquet`.
...
- `code/01_data_preparation/01b_precompute_individual.py`
- `code/01_data_preparation/01e_match_org_to_asec.py`
- `code/01_data_preparation/01f_precompute_matched_schedules.py`

Behavior:

- Constructs annual-income schedules by `(family_type_key, state_code)`.
- Stores component values over an income grid in:
  - `output/data/intermediate_results/individual_schedules/{family}_{state}.parquet`
- In matched mode, statistically matches ORG workers to ASEC earners and precomputes schedules by matched config key:
  - `data/external/org_asec_matches.parquet`
  - `output/data/intermediate_results/matched_schedules/{config_key}_{state}.parquet`
...
- `code/02_descriptive_analysis/02a_descriptive_stats.py`
- `code/03_matched_analysis/03a_apply_matched_to_population.py` (matched mode)
...
- `output/data/intermediate_results/population/`
...
- `code/04_robustness_heterogeneity/04b_org_validation_framework.py`
- `docs/org_validation_framework.md`
...
.\.venv\Scripts\python.exe code\01_data_preparation\01e_match_org_to_asec.py
.\.venv\Scripts\python.exe code\01_data_preparation\01f_precompute_matched_schedules.py
.\.venv\Scripts\python.exe code\03_matched_analysis\03a_apply_matched_to_population.py
...
- `data/external/org_workers_{max_year}.parquet`
- `data/processed/hourly_workers.parquet`
- population outputs in `output/data/intermediate_results/population/`
- matched outputs in `output/data/intermediate_results/matched_population/`
- validation outputs in `output/validation/`
