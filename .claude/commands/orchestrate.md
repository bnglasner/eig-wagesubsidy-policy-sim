---
description: Create and run a dependency-aware execution plan for a multi-step task, routing workstreams to specialist agents per Infrastructure/AI_WORKFLOW.md. Replans after each wave until completion criteria are met.
...
7. Report status and next action using `.claude/templates/orchestration-plan.md`.

## Constraints

1. Respect `.claude/rules/performance-cost-governance.md` for expensive runs.
