---
description: Run the methodology review on a target project: spawns the methodology-reviewer sub-agent and writes methodology-report.html to <target-dir>/review-reports/.
...
Run the shared pipeline-detection procedure in `.claude/rules/review-pipeline-runner.md`, substituting `<review-type>` = "methodology review".
