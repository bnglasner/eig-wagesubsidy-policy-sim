---
description: Acquire and document a project's data source: fetch the vintage-correct codebook, extract the relevant variables, and persist them to the dataset registry and per-variable Markdown. Enforces permission, no-fabrication, and validation.
argument-hint: "<dataset> [vintage]"
