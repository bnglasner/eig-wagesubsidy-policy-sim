---
description: Run all five RA reviews concurrently (code errors, methodology, AI skeptic, document numbers, document-code consistency) on a target project and write five self-contained HTML reports to <target-dir>/review-reports/.
...
Run the shared pipeline-detection procedure in `.claude/rules/review-pipeline-runner.md`, substituting `<review-type>` = "full review".
...
Rules: .claude/rules/code-quality-rules.md
...
Target directory: <target_dir>
Files to review: [full list of source code file paths]
Rules: .claude/rules/methodology-rules.md
...
Rules: .claude/rules/ai-skeptic-rules.md
...
Rules: .claude/rules/doc-number-rules.md
