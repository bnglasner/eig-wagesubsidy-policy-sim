---
description: Run the AI skeptic review on a target project: spawns the ai-skeptic sub-agent and writes ai-skeptic-report.html to <target-dir>/review-reports/. Does not require a successful pipeline run first.
