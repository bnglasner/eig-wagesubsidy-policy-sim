---
description: Run the repository maintenance sweep (generated-copy drift, internal path integrity, literature catalog, freshness signals) and report prioritized actions.
...
6. Compile findings using `.claude/templates/maintenance-report.md`.

## Output

A maintenance report with:

1. Findings grouped by severity per `.claude/rules/maintenance-rules.md`
