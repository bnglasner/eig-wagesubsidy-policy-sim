...
Imports color and typography tokens from Infrastructure/style/themes/python/eig_tokens.py
and builds a Plotly layout template. Falls back to hardcoded EIG values if the
Infrastructure import fails (e.g. path issues on a deployment server).
...
# ── Load tokens from Infrastructure ────────────────────────────────────────────────────
...
_INFRA_TOKENS = (
    ...
    .parent        # app/
    .parent        # project root
    / "Infrastructure" / "style" / "themes" / "python"
)
