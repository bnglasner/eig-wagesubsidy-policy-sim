...
Renders docs/pipeline_methodology_public.md in a structured,
...
_METHODS_DOC = _PROJECT / "docs" / "pipeline_methodology_public.md"
...
def render() -> None:
    ...
    if not _METHODS_DOC.exists():
        st.warning(
            ...
            "Expected file: `docs/pipeline_methodology_public.md`"
        )
        return
