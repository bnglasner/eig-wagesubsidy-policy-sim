...
Data files live in:
  output/data/intermediate_results/population/          (stylized)
  output/data/intermediate_results/matched_population/  (matched ASEC)
"""
...
# population.py lives at app/tabs/, so repo root is parents[2].
_PROJECT = _HERE.parents[2]
_INTERMEDIATE_DIR = _PROJECT / "output" / "data" / "intermediate_results"
...
def render() -> None:
    ...
    if method_label is None:
        ...
        st.warning(
            ...
            "python code/02_descriptive_analysis/02a_descriptive_stats.py\n"
            "# Optional matched-household pipeline:\n"
            "python code/01_data_preparation/01e_match_org_to_asec.py\n"
            "python code/01_data_preparation/01f_precompute_matched_schedules.py\n"
            "python code/03_matched_analysis/03a_apply_matched_to_population.py\n"
            "```"
        )
